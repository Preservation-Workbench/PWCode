...
# TODO: Test aller først å kunne kjøre dulvwich fra bash script! -> alternativ ha release scipt i python!
...
# PYAPP_PYTHON_VERSION=3.10 PYAPP_FULL_ISOLATION=1 PYAPP_SKIP_INSTALL=1 \
